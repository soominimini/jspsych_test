...
jsPsych.plugins['survey-likert2'] = (function() {
    ...
    plugin.trial = function(display_element, trial) {
      ...
      html += ".jspsych-survey-likert-statement { display:block; font-size: 16px; padding-top: 40px; margin-bottom:30px; }"+
      ...
      //위에 너무 답답함....
      html+='<div style ="position:relative; margin-top:10%;" ><p>지난 일주일 동안 이런 일이 얼마나 자주 일어났는지 해당되는 칸을 선택하세요</p></div>'
